...
/**
 * merge_subarr - This Sort a subarray of integers.
...
/**
 * merge_sort_recursive - This Implementa the merge sort algorithm through recursion.
 * @subarr: This is a subarray of an array of integers to sort.
 * @buff: This is a buffer to store the sorted result.
 * @front: This the front index of the subarray.
