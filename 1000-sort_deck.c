 ...
 * @s1: This the first string to be compared.
 * @s2: This the second string to be compared.
 *
 ...
 * @card: This is a pointer to a deck_node_t card.
 *
 * Return: This the numerical value of the card.
 */
char get_value(deck_node_t *card)
{
