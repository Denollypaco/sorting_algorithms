 ...
 * @a: This the first integer to swap.
 * @b: This the second integer to swap.
 */
void swap_ints(int *a, int *b)
{
	int tmp;
 ...
 * @flow: This is the direction to sort in.
 */
void bitonic_merge(int *array, size_t size, size_t start, size_t seq,
		char flow)
{
 ...
 * @array: This is an array of integers.
 * @size: This is the size of the array.
 * @start: This the starting index of a block of the building bitonic sequence.
 * @seq: This is the size of a block of the building bitonic sequence.
